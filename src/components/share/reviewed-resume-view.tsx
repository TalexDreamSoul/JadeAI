...
function findTextRects(root: HTMLElement, preview: HTMLElement, selectedText: string): ReviewHighlightRect[] {
...
export function ReviewedResumeView({
  ...
  useLayoutEffect(() => {
    ...
    for (const comment of comments) {
      ...
      const rects = findTextRects(root, preview, comment.selectedText);
  ...
  }, [comments, previewRef, resume]);

  return (
    <div className={className}>
      <div className="relative" onMouseUp={onResumeMouseUp} ref={previewRef}>
