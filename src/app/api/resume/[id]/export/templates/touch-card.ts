...
export function buildTouchCardHtml(resume: ResumeWithSections): string {
  return buildTouchSimpleHtml(resume)
    ...
    .replaceAll('<section data-section data-section-type="', '<section data-section class="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-zinc-200/70" data-section-type="');
}
